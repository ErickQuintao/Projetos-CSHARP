...
namespace Infra.Configuracao
{
    public class ContextBase : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            return "Data Source=LAPTOP-5QA0S046;Initial Catalog=FINANCEIRO_2023;Integrated Security=True;User ID=sa;Password=quintao2006;Encrypt=False;TrustServerCertificate=False";
